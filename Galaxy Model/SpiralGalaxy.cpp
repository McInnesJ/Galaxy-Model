...
SpiralGalaxy::SpiralGalaxy(HubbleType hubbleType, std::string name, double redShift, double mass, double stellarMassFraction, std::vector<Galaxy*> satellites){
	this->name = name;
...
SpiralGalaxy::SpiralGalaxy(HubbleType hubbleType, std::string name, double redShift, double mass, double stellarMassFraction){
	this->name = name;
...
void SpiralGalaxy::setHubbleType(HubbleType hubbleType){
	switch (hubbleType){
	case HubbleType::Sa:
		this->hType = "Sa";
		break;
...
void SpiralGalaxy::addSatellite(Galaxy *satellite){
	this->satellites.push_back(satellite);
}

std::string SpiralGalaxy::getName(){
	return this->name;
}
std::string SpiralGalaxy::getHubbleType(){
	return this->hType;
}
double SpiralGalaxy::getStellarMass(){
	return stellarMassFraction*mass;
}
double SpiralGalaxy::getMass(){
	return this->mass;
}
double SpiralGalaxy::getRedShift(){
	return this->redShift;
}
double SpiralGalaxy::getStellarMassFraction(){
	return this->stellarMassFraction;
}
std::vector<Galaxy*> SpiralGalaxy::getSatellites(){
	return this->satellites;
}

void SpiralGalaxy::deleteGalaxy(){
	this->~SpiralGalaxy();
}
